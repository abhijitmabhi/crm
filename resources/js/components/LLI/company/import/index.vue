        ...
        <b-col v-if="2 > status">
            <b-overlay :show="1 === status">
                <b-form-group>
                    ...
                    <p class="mb-0">
                        <small
                            >Der Upload funktioniert am besten, wenn die Dateien nicht zu groß
                            werden (ca 500 Einträge)</small
                        >
                    </p>
                    <p>
                        <small v-if="!spreadsheet" class="text-danger"
                            >Bitte eine Datei hochladen!</small
                        >
                    </p>
                    <div class="mt-4">
...
export default {
    ...
    methods: {
        async importCustomers() {
            ...
            this.status = 1;
            try {
                const response = await axios.post("/company/import", form);
