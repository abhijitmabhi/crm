<template>
    <b-form @submit.prevent="onSubmit" ref="form" novalidate>
        <b-row>
            <b-col>
                <p>
                    <span class="text-danger">Leads können hier nicht terminiert werden!</span>
                    <br />
                    <a href="/leads/schedule">Hier klicken</a>, um Leads zu terminieren
                </p>
            </b-col>
        </b-row>
        <b-row class="mt-3">
        ...
        <b-button class="float-right my-3" variant="outline-success" type="submit">Termin Anlegen</b-button>
    </b-form>
</template>
